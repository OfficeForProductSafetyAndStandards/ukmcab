...
namespace UKMCAB.Web.UI.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel, ILayoutModel
    {
        ...
        public LoginModel(SignInManager<UKMCABUser> signInManager, ILogger<LoginModel> logger)
        {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    ModelState.AddModelError("Input.Email", "Registration request has not yet been approved.");
                }
                else
                {

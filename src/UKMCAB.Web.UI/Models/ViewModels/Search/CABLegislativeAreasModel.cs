...
public class CABLegislativeAreasModel
{
    ...
    public (Guid? Id, string? Name) ProtectionAgainstRisk { get; set; }
    ...
    public (Guid? Id, string? Name) AreaOfCompetency { get; set; }
    ...
    public List<(Guid Id, string Name)> PpeProductTypes { get; set; } = new();
    public List<(Guid? Id, string Name)> ProtectionAgainstRisks { get; set; } = new();
    public List<(Guid Id, string Name)> AreaOfCompetencies { get; set; } = new();

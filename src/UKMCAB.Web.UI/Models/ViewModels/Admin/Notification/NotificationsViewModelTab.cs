...
public record NotificationsViewModelTable(bool ShowTableItems, string SortField, string SortDirection,
    ...
    PaginationViewModel Pagination, MobileSortTableViewModel MobileSortTableViewModel, string TabName, string NoItemsLabel, int TotalCount, string LastUpdatedLabel);
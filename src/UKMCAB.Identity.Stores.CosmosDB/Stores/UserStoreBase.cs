...
#pragma warning restore CS8619
        ...
        public Task RemoveLoginAsync(TUser user, string loginProvider, string providerKey, CancellationToken cancellationToken) => userLoginsTable.DeleteAsync(user, loginProvider, providerKey, cancellationToken);

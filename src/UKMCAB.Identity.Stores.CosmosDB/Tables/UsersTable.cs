...
using UKMCAB.Identity.Stores.CosmosDB.Repositories;
using UKMCAB.Identity.Stores.CosmosDB.Stores;
using UKMCAB.Identity.Stores.CosmosDB.Tables.Interfaces;

namespace UKMCAB.Identity.Stores.CosmosDB.Tables
{
    internal class UsersTable<TUser, TKey> : CosmosContainer, IUsersTable<TUser, TKey>

...
public class CABDocumentBlobEntityTypeConfiguration : IEntityTypeConfiguration<CABDocumentBlob>
{
    public void Configure(EntityTypeBuilder<CABDocumentBlob> builder)
    {
        ...
        builder.Property(a => a.StatusValue).HasColumnType("varchar(1024)").IsRequired();
        builder.Property(a => a.CABId).HasColumnType("varchar(1024)").IsRequired();
        ...
        builder.Property(a => a.Version).HasColumnType("varchar(1024)").IsRequired();
    }
}
...
namespace UKMCAB.Data.Models
{
    public class Audit
    {
        ...
        public Audit(UserAccount? userAccount, string action, string comment = null, string publicComment = null) : this(userAccount?.Id, $"{userAccount?.FirstName} {userAccount?.Surname}", userAccount?.RoleId, DateTime.UtcNow, action, comment, publicComment) { }

        public Audit(UserAccount? userAccount, string action, Document publishedDocument, Document? previousDocument = null) : this(userAccount?.Id, $"{userAccount?.FirstName} {userAccount?.Surname}", userAccount?.RoleId, DateTime.UtcNow, action)
        {

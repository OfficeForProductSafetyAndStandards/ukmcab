...
public class SubscriptionEngineTests
{
    ...
    public void SetupOnce()
    {
        ...
        services.AddSingleton(new DataConnectionString("mock-connection-string"));
        services.AddSingleton(new SubscriptionDataConnectionString("mock-connection-string"));
